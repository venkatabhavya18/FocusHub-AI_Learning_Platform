...
def recommend_topics(focus_score, topics, k=3):
    """
    Recommends top-k topics based on focus score and difficulty
    """
...
if __name__ == "__main__":
    ...
    topics = [
        ...
        {"name": "Linked Lists", "difficulty": 4},
        {"name": "Recursion", "difficulty": 5},
        {"name": "Sorting", "difficulty": 2},
        {"name": "Searching", "difficulty": 2}
    ]

    recommendations = recommend_topics(focus_score, topics, k=3)
